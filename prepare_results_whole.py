...
for i in range(nsplit):
	...
	for k in range(reps): # for all the repetitions
		...
		likelihood4[:,k] = (my_data1[1:N+1,2]*ssplit[i] + my_data1[1:N+1,6]*ntest)/(ssplit[i]+ntest)
		...
		likelihood1[:,k] = (my_data4[1:N+1,2]*ssplit[i] + my_data4[1:N+1,9]*ntest)/(ssplit[i]+ntest)
